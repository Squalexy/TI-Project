...
/*
    https://algs4.cs.princeton.edu/55compression/Alphabet.java.html
 */
public class Alphabet {
    ...
    public void setInverse(int[] inverse) { this.inverse = inverse; }
    ...
    /**
     * Unit tests the {@code Utils.Alphabet} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        //edu.princeton.cs.algs4.StdOut.println(decoded1);

        int[]  encoded2 = Alphabet.DNA.toIndices("AACGAACGGTTTACCCCG");
        String decoded2 = Alphabet.DNA.toChars(encoded2);
        //edu.princeton.cs.algs4.StdOut.println(decoded2);

        int[]  encoded3 = Alphabet.DECIMAL.toIndices("01234567890123456789");
        String decoded3 = Alphabet.DECIMAL.toChars(encoded3);
        //edu.princeton.cs.algs4.StdOut.println(decoded3);
    }
}